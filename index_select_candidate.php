                  ...
                  if (isset($_POST['search2'])) 
                  {
                    ...
                    while ($row = mysqli_fetch_array($query_run)) 
                    {
                      ...
                      ?>
                        ...
                        <tr>                         
                          <td><?php echo $row['ee_fnm']?></td>
                          <td><?php echo $row['ee_email']?></td>
                          <td><?php echo $row['ee_add']?></td>
                          <td><?php echo $row['ee_current_location']?></td>
                          <td><?php echo $row['ee_qualification']?></td>
                          <td><?php echo $row['ee_profile']?></td>
                          <td><?php echo $row['ee_current_industry']?></td>
