      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="index.php" class="text-black h2 mb-0"> &nbsp Hi,<b><?php echo htmlspecialchars($_SESSION["username"]); ?></b></h1>
          ...
          <div class="col-10 col-xl-10 d-none d-xl-block">
            <nav class="site-navigation text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="new-post.php"><span class="btn btn-danger"><span class=" glyphicon glyphicon-file"></span> Post a Job</span></a></li>
    ...
    <div class="site-blocks-cover" style="background-image: url(images/abc.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row row-custom align-items-center">
          <div class="col-md-10">
            <h1 class="mb-2 text-black w-75"><span class="font-weight-bold">Find Your</span> Dream Job</h1>
            <div class="job-search">
              ...
              <div class="tab-content bg-white p-4 rounded" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-job" role="tabpanel" aria-labelledby="pills-job-tab">
                  ...
                  <form action="index_select_find_job.php" method="post">
                    <div class="row">
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <input type="text" name="j_name" class="form-control" placeholder="eg. Web Developer" >
                      ...
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="select-wrap">
                          ...
                          <select name="" id="" class="form-control">
                            <option value="">
                              <?php
                                $q = "select cat_nm from categories";
                ...
                <a href="index_select_find_job.php"><input type="submit" name="search1" class="btn btn-primary btn-block" value="Search"></a>
                ...
                <div class="tab-pane fade" id="pills-candidate" role="tabpanel" aria-labelledby="pills-candidate-tab">
                     ...
                     <form action="index_select_candidate.php" method="post">
                    <div class="row">
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">

                        <input type="text" name="c_name" class="form-control" placeholder="eg. Carl Smith">
                      </div>
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="select-wrap">
                          <span class="icon-keyboard_arrow_down arrow-down"></span>
                     ...
                     <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                      ...
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <a href=""><input type="submit" name="search2" class="btn btn-primary btn-block" value="Search"></a>
                      </div>
                    </div>
                  </form>
                </div>
