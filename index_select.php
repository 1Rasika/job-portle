      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="index.html" class="text-black h2 mb-0">Good<strong>JoB</strong></a></h1>
          </div>
      ...
      <div class="container">
        <div class="row row-custom align-items-center">
          <div class="col-md-10">
            ...
            <h1 class="mb-2 text-black w-75"><span class="font-weight-bold" align="top">your deatail</h1></span>
            <table border="1" bgcolor="white">
              <th width="90">job_id</th>
              <th width="90">job_title</th>
              <th width="90">company</th>
              <th width="90">job_type</th>
            ...
            <?php
                  ...
                  if (isset($_POST['se'])) 
                  {
                   ...
                   $id=$_POST["can_name"];
                    ...
                    $query = "SELECT * FROM new_postjob where job_title ='$id'" ;
