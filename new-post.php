      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form class="p-5 bg-white" method="POST" action="new_post.php">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" class="form-control" placeholder="eg. Web Developer" name="jn" required="required">
                </div>
              </div>
              ...
              <div class="row form-group mb-5">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" class="form-control" placeholder="eg. IT finder" name="com" required="required">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-1">
                    <input type="radio" id="option-job-type-1" name="job_type" value="full time" required="required"> Full Time
                  </label>
                </div>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-2">
                    <input type="radio" id="option-job-type-2" name="job_type" value="part time" required="required"> Part Time
                  </label>
                </div>

                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-4">
                    <input type="radio" id="option-job-type-4" name="job_type" value="intern ship" required="required"> Internship
                  </label>
                </div>
              ...
              <div class="row form-group mb-20">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <input type="text" class="form-control" placeholder="Colombo" name="loc" required="required">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <textarea name="dic" class="form-control" id="" cols="30" rows="5" required="required"></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Post" id="nbtn" class="btn btn-primary  py-2 px-5">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">Sri Lanka,kandy</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">027-2247405</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">hirupathu@gmail.com</a></p>
